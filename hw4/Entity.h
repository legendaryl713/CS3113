...
enum EntityType { PLATFORM, PLAYER, ENEMY, ROCKET  };
enum AIType     { WALKER, GUARD, BOMBER, SENTINEL    };
...
public:
    ...
    void ai_bomber(Entity* player);
    void he_win() { won = true; };
    void he_lose() { won = false; };
